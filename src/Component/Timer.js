...
export default function Timer(){
    ...
    let interval=useRef();
    const startTimer=()=> {
        const countdownDate = new Date("30-May 2023 12:00 AM").getTime();  //method is Date.getTime(),countdownDate 
        //is initial value
    ...
    return(
        <div className='title'>
            ...
            <h3 className='header'>Just Waiting for that special day🎂 30 May 2023 12:00 AM</h3>
            <div className='main'>
               <div>
